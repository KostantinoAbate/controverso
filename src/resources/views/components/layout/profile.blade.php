...
<x-block.profile.navbar/>
<div class="container bg-base-100 rounded-b-xl max-[1400px]:rounded-none shadow-lg min-h-screen flex flex-row max-md:flex-col justify-start items-start pt-14 gap-8">
    <x-block.profile.sidebar/>
    <div class="format grow h-auto p-4 bg-base-100">
        {{ $slot }}
    </div>
</div>
<x-block.footer/>
<x-utility.logout/>
@javascript('routeLayout', 'profile')
